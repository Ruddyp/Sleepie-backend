...
const audio = await clientEL.textToSpeech.convert(voiceId, {
  text: "Le premier geste met tout en mouvement. Respire et détends-toi.", //ajouter le résultat de la génération de texte ici
...
const resultCloudinary = await cloudinary.uploader.upload("./quickstart_test.mp3", { resource_type: "raw" });
